package main.java.org.redrock.ioc.framework1.core;
...
public class ControllerLoader {
    ...
    private Class<?> loadClass(String className, boolean isInitilize){
        Class<?> clazz = null;
        try {
            clazz = Class.forName(className, isInitilize, getClass().getClassLoader());
